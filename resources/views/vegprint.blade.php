<div  class="modal fade" id="vegprint-modal" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content" style="width: 500px;left:190px;top:150px;">
        <div class="modal-header" style="height: 10px;">
          <h4 class="modal-title" id="VegPrintModal"></h4>
        </div>
        <div class="modal-body">
          <form action="javascript:void(0)" id="VegPrintForm" name="VegPrintForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
