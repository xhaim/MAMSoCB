...
//  END ARCHIVE AJAX   //  END ARCHIVE AJAX   //  END ARCHIVE AJAX   //  END ARCHIVE AJAX   //  END ARCHIVE AJAX   //  END ARCHIVE AJAX   //  END ARCHIVE AJAX   //
  ...
  function editFunc(id){
    ...
    $.ajax({
      ...
      function printModal(){
                    // $('#coffeeBar').html("Edit coffee");
                    $('#coffeeprint-modal').modal('show');
            }
            ...
            function printDatas() {
                    ...
                    $('#coffeeprint-modal').modal('hide');
            }
            // AJAX request to fetch data from the server
            function printDataTable() {
                    $.ajax({
                        url: '/print-coffee', // Replace with your Laravel route URL to fetch data
                        method: 'GET',
            ...
            function printDataTableBar(selectedBarangay) {
                    $.ajax({
                        url: '/print-coffeebar', // Replace with your Laravel route URL to fetch data
                        method: 'GET',
