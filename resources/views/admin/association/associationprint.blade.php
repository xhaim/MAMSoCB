<div  class="modal fade" id="assocprint-modal" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <<div class="modal-content" style="width: 500px;left:190px;top:150px;">
        <div class="modal-header" style="height: 10px;">
          <h4 class="modal-title" id="AssocPrintModal"></h4>
        </div>
        <div class="modal-body">
          <form action="javascript:void(0)" id="AssocPrintForm" name="AssocPrintForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
