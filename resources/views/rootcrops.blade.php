...
//  END ARCHIVE AJAX   //  END ARCHIVE AJAX   //  END ARCHIVE AJAX   //  END ARCHIVE AJAX   //  END ARCHIVE AJAX   //  END ARCHIVE AJAX   //  END ARCHIVE AJAX   //
  ...
  function editFunc(id){
    ...
    $.ajax({
      ...
      function printModal(){
                    // $('#rootBar').html("Edit root");
                    $('#rootprint-modal').modal('show');
            }
            ...
            function printDatas() {
                    ...
                    $('#rootprint-modal').modal('hide');
            }
            // AJAX request to fetch data from the server
            function printDataTable() {
                    $.ajax({
                        url: '/print-root', // Replace with your Laravel route URL to fetch data
                        method: 'GET',
            ...
            function printDataTableBar(selectedBarangay) {
                    $.ajax({
                        url: '/print-rootbar', // Replace with your Laravel route URL to fetch data
                        method: 'GET',
